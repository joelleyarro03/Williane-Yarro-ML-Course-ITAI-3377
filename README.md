...
**Course:** ITAI-3377-Edge AI and IIoT  
...
- Edge AI development environments and tools
- Simulated edge device deployment
- AI model deployment using Visual Studio Code
- IIoT sensor network design
- Communication protocols for IIoT systems
- AI-driven data analytics with Nixtla
- Network analysis with Age of Information and reliability trade-offs
- Autonomous agents in Industry 4.0
- Generative AI for Edge and IIoT systems

## Tools and Technologies Used
Some of the tools, platforms, and concepts used in this course include:

- Visual Studio Code
- Edge AI simulation environments
- IIoT protocols
...
- **A03** – Case Study Analysis on Edge-Computing Video Analytics for Real-Time Traffic Monitoring in a Smart City  
- **A04** – Individual Reflective Journal about Lab 04  
- **A06** – AI Driven Data Analytics with Nixtla  
...
- **L02** – Deploying an AI Model on a Simulated Edge Device (2 Options)  
- **L03** – Deploying a Simple AI Model on a Simulated Edge Device using Visual Studio Code  
